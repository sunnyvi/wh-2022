...
@Data
@TableName("shipping_order_line")
@ApiModel(value="shipping_order_line对象", description="shipping_order_line")
public class ShippingOrderLine implements Serializable {

...
@Data
@TableName("shipping_order_header")
@ApiModel(value="shipping_order_header对象", description="shipping_order_header")
public class ShippingOrderHeader implements Serializable {
